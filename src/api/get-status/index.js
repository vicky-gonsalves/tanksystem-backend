...
const {motor, automate, tankFilled, websocket, cutOff, waterHeight, skipCutoff, updatedByDevice} = schema.tree;
 ...
 */
router.post('/',
  body({motor, automate, tankFilled, websocket, cutOff, waterHeight, skipCutoff, updatedByDevice}),
  create);
