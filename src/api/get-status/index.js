...
const {motor, automate, tankFilled, websocket, cutOff, waterHeight, skipCutoff, updatedByDevice, devLogs} = schema.tree;
 ...
 */
router.post('/',
  body({motor, automate, tankFilled, websocket, cutOff, waterHeight, skipCutoff, updatedByDevice, devLogs}),
  create);
