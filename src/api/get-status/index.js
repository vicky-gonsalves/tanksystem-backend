...
const {motor, automate, tankFilled, websocket, waterHeight, skipCutoff, updatedByDevice} = schema.tree;
 ...
 */
router.post('/',
  body({motor, automate, tankFilled, websocket, waterHeight, skipCutoff, updatedByDevice}),
  create);
