...
const {action, motorOn, cutOff, automate, tankFilled, waterHeight, skipCutoff, websocket, updatedByDevice, quantity, flowRate} = schema.tree;
 ...
 */
router.post('/',
  body({action, motorOn, cutOff, automate, tankFilled, waterHeight, skipCutoff, websocket, updatedByDevice, quantity, flowRate}),
  create);
